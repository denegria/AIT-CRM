...
def render_markdown(payload: dict) -> str:
    lines = [
        ...
        f"- possible duplicate groups for review: {payload['counts'].get('possibleDuplicateGroups', 0)}",
    ...
    lines.extend(
        [
            ...
            "- explicit source-row phone resolutions merge confirmed near-duplicate contacts only",
            "- structured lead metadata preserves call eligibility, preferences, level/test hints, source tags, and contactability status",
