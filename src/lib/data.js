...
export const contacts = [
  { id: 'c-1', name: 'Marcus Thompson', email: 'marcus.t@email.com', phone: '(555) 234-8901', status: 'New Lead', source: 'Facebook Ads', assignedTo: 'emp-1', lastContact: d(-1), notes: [{ text: 'Interested in full HVAC system for new build.', date: d(-1) }] },
  { id: 'c-2', name: 'Sarah Chen', email: 'schen@chenoffice.com', phone: '(555) 345-1234', status: 'Contacted', source: 'Website', assignedTo: 'emp-2', lastContact: d(-3), notes: [{ text: 'Office complex, needs duct cleaning quote.', date: d(-3) }] },
  { id: 'c-3', name: 'David Rodriguez', email: 'drodriguez@gmail.com', phone: '(555) 456-7890', status: 'Qualified', source: 'Referral', assignedTo: 'emp-1', lastContact: d(-2), notes: [{ text: 'Referred by Mitchell. AC issues.', date: d(-2) }] },
  { id: 'c-4', name: 'Emily Watson', email: 'ewatson@watsonbldg.com', phone: '(555) 567-2345', status: 'Proposal Sent', source: 'Facebook Ads', assignedTo: 'emp-3', lastContact: d(-5), notes: [{ text: 'Sent furnace replacement estimate. Awaiting approval.', date: d(-5) }] },
  { id: 'c-5', name: 'James Mitchell', email: 'jmitchell@mitchellplaza.com', phone: '(555) 678-3456', status: 'Won', source: 'Cold Call', assignedTo: 'emp-1', lastContact: d(-7), notes: [{ text: 'Signed maintenance contract. Quarterly service.', date: d(-7) }] },
  { id: 'c-6', name: 'Lisa Park', email: 'lisa.park@email.com', phone: '(555) 789-4567', status: 'New Lead', source: 'Facebook Ads', assignedTo: 'emp-2', lastContact: d(0), notes: [{ text: 'Inquired about smart thermostat install.', date: d(0) }] },
  { id: 'c-7', name: 'Robert Johnson', email: 'rjohnson@jwarehouse.com', phone: '(555) 890-5678', status: 'Contacted', source: 'Website', assignedTo: 'emp-3', lastContact: d(-4), notes: [{ text: 'Warehouse heating system. Large commercial job.', date: d(-4) }] },
  { id: 'c-8', name: 'Amanda Foster', email: 'afoster@fosterco.com', phone: '(555) 901-6789', status: 'Lost', source: 'Referral', assignedTo: 'emp-1', lastContact: d(-14), notes: [{ text: 'Went with competitor. Price sensitive.', date: d(-14) }] },
  { id: 'c-9', name: 'Michael Brown', email: 'mbrown@email.com', phone: '(555) 012-7890', status: 'Qualified', source: 'Facebook Ads', assignedTo: 'emp-2', lastContact: d(-1), notes: [{ text: 'Residential AC replacement. 3-ton unit.', date: d(-1) }] },
  { id: 'c-10', name: 'Jennifer Davis', email: 'jdavis@email.com', phone: '(555) 123-8901', status: 'New Lead', source: 'Google Ads', assignedTo: 'emp-3', lastContact: d(0), notes: [{ text: 'Emergency heat repair inquiry.', date: d(0) }] },
  { id: 'c-11', name: 'Christopher Lee', email: 'clee@leegroup.com', phone: '(555) 234-9012', status: 'Won', source: 'Referral', assignedTo: 'emp-1', lastContact: d(-10), notes: [{ text: 'Completed install. Happy customer.', date: d(-10) }] },
  { id: 'c-12', name: 'Nicole Martinez', email: 'nmartinez@email.com', phone: '(555) 345-0123', status: 'Proposal Sent', source: 'Cold Call', assignedTo: 'emp-2', lastContact: d(-6), notes: [{ text: 'Multi-unit property. Waiting on board approval.', date: d(-6) }] },
  { id: 'c-13', name: 'Andrew Wilson', email: 'awilson@email.com', phone: '(555) 456-1234', status: 'Contacted', source: 'Facebook Ads', assignedTo: 'emp-3', lastContact: d(-2), notes: [{ text: 'Scheduled site visit for next week.', date: d(-2) }] },
  { id: 'c-14', name: 'Stephanie Taylor', email: 'staylor@email.com', phone: '(555) 567-2345', status: 'New Lead', source: 'Website', assignedTo: 'emp-1', lastContact: d(0), notes: [{ text: 'Form submission — mini-split inquiry.', date: d(0) }] },
  { id: 'c-15', name: 'Kevin Anderson', email: 'kanderson@andersonhvac.com', phone: '(555) 678-3456', status: 'Qualified', source: 'Referral', assignedTo: 'emp-2', lastContact: d(-3), notes: [{ text: 'Subcontractor opportunity. Large project.', date: d(-3) }] },
];
