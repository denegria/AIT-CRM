...
export const WORKFLOW_DEFINITIONS = {
  ...
  [WORKFLOW_KEYS.AIT_USA]: {
    ...
    statuses: ['New Lead', 'Follow Up', 'Enrolled', 'Dropped / Quit', 'Retargeting', 'Not Interested', 'Course Completed'],
    activeStatuses: ['New Lead', 'Follow Up', 'Enrolled'],
    closedStatuses: ['Dropped / Quit', 'Retargeting', 'Not Interested', 'Course Completed'],
    terminalStatuses: ['Dropped / Quit', 'Retargeting', 'Not Interested', 'Course Completed'],
  },
...
const WORKFLOW_ALIASES = {
  [WORKFLOW_KEYS.AIT_USA]: new Map([
    ...
    ['sold', 'Enrolled'],
    ['drop', 'Dropped / Quit'],
    ['dropped', 'Dropped / Quit'],
    ['dropped course', 'Dropped / Quit'],
    ['dropped out', 'Dropped / Quit'],
    ['course dropped', 'Dropped / Quit'],
    ['withdraw', 'Dropped / Quit'],
    ['withdrawn', 'Dropped / Quit'],
    ['withdrew', 'Dropped / Quit'],
    ['quit', 'Dropped / Quit'],
    ['quitted', 'Dropped / Quit'],
    ['quit course', 'Dropped / Quit'],
    ['course quit', 'Dropped / Quit'],
    ['stopped', 'Dropped / Quit'],
    ['stopped attending', 'Dropped / Quit'],
